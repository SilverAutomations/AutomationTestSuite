...
def select_browser(pw: Playwright, brwsr: str, headless: bool, cdp: bool):
    ...
    # box in shortcut properties so that the target path becomes: "C:\Program
    # Files\Google\Chrome\Application\chrome.exe" --remote-debugging-port=9222 Now start Chrome and check if it is in
